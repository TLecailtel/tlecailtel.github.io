...
function refreshPiano(div1,div2,i){
    ...
    svg_piano.attr("x",d3.select("#valeur_piano").attr("x"))
	svg_piano.attr("y",d3.select("#valeur_piano").attr("y"))
}
...
function refreshBook(div1,div2,i){
    ...
    svg_book.attr("x",d3.select("#valeur_histoire").attr("x"))
	svg_book.attr("y",d3.select("#valeur_histoire").attr("y"))
}
...
function refreshVoiture(acc1,acc2,i){
	...
	svg_voiture.attr("x",d3.select("#valeur_voiture").attr("x"))
	svg_voiture.attr("y",d3.select("#valeur_voiture").attr("y"))
}
...
function refreshTaxis(acc1,acc2,i){
	...
	svg_taxis.attr("x",d3.select("#valeur_taxis").attr("x"))
	svg_taxis.attr("y",d3.select("#valeur_taxis").attr("y"))
}
...
function refreshMarche(acc1,acc2,i){
	...
	svg_marche.attr("x",d3.select("#valeur_marche").attr("x"))
	svg_marche.attr("y",d3.select("#valeur_marche").attr("y"))
}
